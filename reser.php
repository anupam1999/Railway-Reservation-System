	...
	<div class="wrap">
		...
		<h2><font color="blue">Passenger Detail</font></h2>
			...
			<table class="table">
				...
				<tr>
					<td > 1</td>
					<td ><input type="text" name="name1" autocomplete="off"></td>
					<td ><input type="text" name="age1" class="input-small" autocomplete="off"></td>
				...
				<tr>
					<td > 2</td>
					<td ><input type="text" name="name2" autocomplete="off"></td>
					<td ><input type="text" name="age2" class="input-small" autocomplete="off"></td>
				...
				<tr>
					<td > 3</td>
					<td ><input type="text" name="name3" autocomplete="off"></td>
					<td ><input type="text" name="age3" class="input-small" autocomplete="off"></td>
				...
				<tr>
					<td > 4</td>
					<td ><input type="text" name="name4" autocomplete="off"></td>
					<td ><input type="text" name="age4" class="input-small" autocomplete="off"></td>
				...
				<tr>
					<td > 5</td>
					<td ><input type="text" name="name5" autocomplete="off"></td>
					<td ><input type="text" name="age5" class="input-small" autocomplete="off"></td>
		...
		<div>
		<br  />
		<b> <marquee><font style="text-shadow: 1px 1px 2px white,0 0 10px black,0 0 5px white;color:red;"> No need to take out ticket of children aged 5yrs or below 5yrs. </font></marquee> </b>
		</div>
