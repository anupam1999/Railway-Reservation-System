	...
	<div class="wrap">
		...
		<div class="span12 well" align="center">
			...
			<h4>Accepted <b style="color:#ff3333">Debit/Credit</b> Card</h4>
				...
				<label for="name">Name on Card<font color="red">*</font></label><br/>
				<input type="text" name="cardname" id="cname" style="width:25%;" class="input-block-level" placeholder="Enter Name on card" autocomplete="off" />
