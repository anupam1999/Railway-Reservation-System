		...
		<div class="row">
			...
			<table class="table">
				<tr>
					...
					<td style="border-top:0px;"><input type="text" class="input-block-level" name="from" id="fr" autocomplete="off"></td>
				</tr>
				<tr>
					<th style="border-top:0px;"><label> To <label></th>
					<td style="border-top:0px;"><input type="text" class="input-block-level" name="to" id="to1" autocomplete="off"></td>
				</tr>
				<tr>
					<th style="border-top:0px;" ><label > Quota <label></th>
					<td style="border-top:0px;"><input list="q1" class="input-block-level" name="quota" id="q12" autocomplete="off" value="<?php if(isset($_POST['quota']))echo $_POST['quota'];?>">
					<datalist id="q1" >
